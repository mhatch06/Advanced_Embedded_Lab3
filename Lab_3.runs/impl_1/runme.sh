...
HD_PWD='Z:/EENG498/Lab_3/Lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log signalAcquire.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source signalAcquire.tcl -notrace
