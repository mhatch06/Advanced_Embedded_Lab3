...
HD_PWD='Z:/EENG498/Lab_3/Lab_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signalAcquire.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signalAcquire.tcl
